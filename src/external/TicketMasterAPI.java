...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "OQ32lV3EAKXnGGqI2wSQv2K90YbFqObU";
...
//		return new ArrayList<>();
		...
		try {
			...
			connection.setRequestMethod("GET");
			// Send request to TicketMater and get response, response code could be returned directly
	...
	// for testing purposes, prints results from search in the console
	...
	// Convert JSONArray to a list of item or objects
